...
class WaypointUpdater(object):
    ...
    def get_closest_waypoint_id(self):
        ...
        val = np.dot(cl_vect - prev_vect, post_vect - cl_vest)
        
        if val > 0:
            closest_idx = (closest_idx + 1) % len(self.wayoints_2d)  
        return closest_idx
    ...
    def publish_waypoints(self, closest_idx):
        ...
        lane.waypoints = self.base_waypoints.waypoints[closest_idx:closest_idx + LOOKAHEAD_WPS] # give the waypoint sliced to the end. 
